...
export default function Settings() {
  ...
  const handleUpdateKey = (updatedKey: Key) => {
    setSettings((prev) => ({
      ...prev,
      keys: prev.keys.map((key) => (key.id === updatedKey.id ? updatedKey : key)),
    }));
    setEditingKey(null);
  };
                ...
                <div className="max-w-3xl space-y-12">
                  ...
                  <section id="models">
                    ...
                    {settings.models.map((model) => (
                      <ToggleableItem key={model.id} {...model} onToggle={handleModelToggle} />
                    ))}
                  </section>
                  ...
                  <section id="extensions">
                    ...
                    {settings.extensions.map((ext) => (
                      <ToggleableItem key={ext.id} {...ext} onToggle={handleExtensionToggle} />
                    ))}
                  </section>
        ...
        <ModalContent>
          ...
          <div className="py-4">
            <p className="text-gray-600 dark:text-gray-300">
              Are you sure you want to reset all settings to their default values? This cannot be
              undone.
            </p>
          </div>
